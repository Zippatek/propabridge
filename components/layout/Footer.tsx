...
import { WhatsappLogo, EnvelopeSimple, MapPin, HouseSimple } from '@phosphor-icons/react/dist/ssr'
        ...
        <div className="container-site">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-10 mb-16">
            ...
            <div className="grid grid-cols-3 gap-3 shrink-0 lg:mt-6">
              <Link href="#" aria-label="LinkedIn" className="w-[52px] h-[52px] bg-white/5 hover:bg-white/10 border border-white/5 rounded-[14px] flex items-center justify-center transition-colors">
              ...
              <Link href="#" aria-label="Facebook" className="w-[52px] h-[52px] bg-white/5 hover:bg-white/10 border border-white/5 rounded-[14px] flex items-center justify-center transition-colors">
              ...
              <Link href="#" aria-label="TikTok" className="w-[52px] h-[52px] bg-white/5 hover:bg-white/10 border border-white/5 rounded-[14px] flex items-center justify-center transition-colors">
              ...
              <Link href="#" aria-label="Instagram" className="w-[52px] h-[52px] bg-white/5 hover:bg-white/10 border border-white/5 rounded-[14px] flex items-center justify-center transition-colors">
              ...
              <Link href="#" aria-label="YouTube" className="w-[52px] h-[52px] bg-white/5 hover:bg-white/10 border border-white/5 rounded-[14px] flex items-center justify-center transition-colors">
              ...
              <Link href="#" aria-label="X (Twitter)" className="w-[52px] h-[52px] bg-white/5 hover:bg-white/10 border border-white/5 rounded-[14px] flex items-center justify-center transition-colors">
          ...
          <div className="flex flex-col lg:flex-row items-end justify-between gap-10">
            ...
            <div className="w-full max-w-[500px] order-1 lg:order-2 mx-auto lg:mx-0 mr-auto lg:mr-24">
              ...
              <form className="flex bg-[#fcfdf8] p-1.5 rounded-full shadow-sm w-full h-[64px]">
                <input 
                  type="email" 
                ...
                <button 
                  type="submit" 
                  className="bg-navy shrink-0 text-white font-semibold text-[12px] sm:text-[13px] uppercase tracking-wider px-5 sm:px-8 h-full rounded-full flex items-center justify-center gap-1.5 sm:gap-2 hover:bg-navy/90 transition-colors"
                >
