  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'h3-l': ['26px', { lineHeight: '1.3', letterSpacing: '0', fontWeight: '600' }],
        'h3-m': ['20px', { lineHeight: '1.3', letterSpacing: '0', fontWeight: '600' }],
        'h3-s': ['16px', { lineHeight: '1.3', letterSpacing: '0', fontWeight: '600' }],
        h4: ['18px', { lineHeight: '1.5', letterSpacing: '0', fontWeight: '600' }],
